...
class Timesheet implements EntityWithMetaFields, ExportItemInterface
{
     ...
     *
     * @ORM\Column(name="aprem_start_time", type="time", nullable=true)
     */
    private $mBegin;
     ...
     * Attention: Accessor MUST be used, otherwise date will be serialized in UTC.
     *
     * @ORM\Column(name="morning_end_time", type="time", nullable=true)
     */
    private $mEnd;
    /**
     * @var DateTime
     ...
     * Attention: Accessor MUST be used, otherwise date will be serialized in UTC.
     *
     * @ORM\Column(name="morning_start_time", type="datetime", nullable=false)
     * @Assert\NotNull()
     */
    private $begin;
    /**
